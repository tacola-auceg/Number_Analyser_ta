...
public class Utils {
    ...
    public static String readData(String fileName) {
        System.out.println("Enter into Utils readData method");
        String s = "";
    ...
    public static void writeData(String words, String fileName) {
        System.out.println("Enter into Utils writeData method");
    ...
    public static String removeTag(String ip) {
        System.out.println("Enter into Utils removeTag method");
    ...
    static String parseLine1(String input, StringBuffer output) {
        System.out.println("Enter into Utils parseLine1 method");
        try {
            int ltIndex = -1;
            int gtIndex = -1;
