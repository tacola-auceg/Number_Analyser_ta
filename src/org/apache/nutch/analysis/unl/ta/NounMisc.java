...
public class NounMisc {
    ...
    public static boolean adjective(Stack s) {
        System.out.println("Enter into NounMisc adjective method");
    ...
    public static boolean angu_ingu_engu(Stack s) {
        System.out.println("Enter into NounMisc angu_ingu_engu method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean adverb(Stack s) {
        System.out.println("Enter into NounMisc adverb method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean pronominal(Stack s) {
        System.out.println("Enter into NounMisc pronominal method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean finiteVerb(Stack s) {
        System.out.println("Enter into NounMisc finiteVerb method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean checkNumber(Stack allStk, String inputString) {
        System.out.println("Enter into NounMisc checkNumber method");
        Stack s = new Stack();

        try {
            String strs = (new String(inputString)).intern(); //Assigning the inputString to strs
