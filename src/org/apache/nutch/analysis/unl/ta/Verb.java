...
public class Verb {
    ...
    public static boolean check(Stack allStk, byte[] topElmt, boolean analysePart) {
        System.out.println("Enter into Verb check method");
        ...
        while (flag < 2) {
            ...
            if (flag == 0) { //this will work when the above all rules produce false as value
	...
	/*	if(gotoVerbExp)
            ...
            if (nopng) { //now noflg=true bcoz the condition flag==0 is work
...
// "al"
            ...
            // 12 - VP
            if (ADictionary.noun(s)) {
                //System.out.println("Enter into true");
                allStk.push(s);
                return true;
            }
            ////System.out.println("30");
		/*	if(ADictionary.Nverb(s))
            ...
            if (Sandhi.verbException(s)) {
                ...
                if (ADictionary.verb(s)) {
                    System.out.println("Enter into this method ");
                    allStk.push(s);
                    return true;
                }
            }
            ////System.out.println("32");
            if (analysePart) {
                System.out.println("afioahfig");
                allStk.push(s);
            }
            System.out.println("afioahfig vdfas "+s);
            flag++;
        }
        System.out.println("33 s");
        if (ADictionary.verb(s)) {
            System.out.println("Enter into this method 1");
            allStk.push(s);
            return true;
        } else if (ADictionary.m_EndNoun(s)) {
            System.out.println("Enter into this method 2");
            allStk.push(s);
            return true;
        }
