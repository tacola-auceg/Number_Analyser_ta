...
public class Clitic {
    ...
    public static boolean check(Stack s) {
        //System.out.println("Enter into clitic check method");
        for (int i = 0; i < rule.length; i++) {
           // //System.out.println("i "+i);
            originalStk = (Stack) s.clone();
            int cRIndex = 0;
           // //System.out.println("Rule :" + UnicodeConverter.revert(rule[i]));
            byte currentRule[] = new byte[rule[i].length];

            byte[] topElmt = ((Entry) s.peek()).getPart();
            byte[] oldTopElmt = topElmt;
           //System.out.println("clitic value in check method"+UnicodeConverter.revert(topElmt));
            for (int j = rule[i].length - 1; j >= 0; j--) {
                //System.out.println("Enter into for");
               // //System.out.println("j"+j);
                // //System.out.println("Rule in for loop:" + UnicodeConverter.revert(rule[i]));
                switch (rule[i][j]) {
            ...
            if (ByteMeth.isEqual(rule[i], currentRule)) {
                //System.out.println("Ebnter into isEqual rule");
                return true;
            } else {
                Misc.backTrack(originalStk, s);
               /* while (!originalStk.empty()) {
                    System.out.print("Stack value :"+originalStk.pop() + "  ");
                }*/
                //Misc.printArray(topElmt);
            }
        }
    ...
    static boolean verb(Stack s) {
        //System.out.println("Enter into clitic verb method");
        // no thAn
        //AlthAn
        if (clitic_3a(s)) {
            return true;
    ...
    static boolean verb1(Stack s) {
        //System.out.println("Enter into clitic verb1 method");
        // no thAn
        //AlthAn
        if (clitic_3a(s)) {
            return true;
    ...
    static boolean clitic_1(Stack s, boolean noun) {
        //System.out.println("Enter into clitic clitic_1 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_2(Stack s) {
        //System.out.println("Enter into clitic clitic_2 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_3(Stack s) {
        //System.out.println("Enter into clitic clitic_3 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_3a(Stack s) {
        //System.out.println("Enter into clitic clitic_3a method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_4(Stack s) {
        //System.out.println("Enter into clitic clitic_4 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_5(Stack s) {
        //System.out.println("Enter into clitic clitic_5 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_6(Stack s) {
        //System.out.println("Enter into clitic clitic_6 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_7(Stack s) {
        //System.out.println("Enter into clitic clitic_7 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_8(Stack s) {
        //System.out.println("Enter into clitic clitic_8 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_9(Stack s) {
        //System.out.println("Enter into clitic clitic_9 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_10(Stack s) {
        //System.out.println("Enter into clitic clitic_10 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean clitic_11(Stack s) {
        //System.out.println("Enter into clitic clitic_11 method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
