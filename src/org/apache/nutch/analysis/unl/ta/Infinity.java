...
public class Infinity {
    ...
    public static boolean kka_ka(Stack s) {
        System.out.println("Enter into Infinity kka_ka method");
    ...
    public static boolean a(Stack s) {
        System.out.println("Enter into Infinity a method");
    ...
    public static boolean infinitive_Ends(Stack s) {
        System.out.println("Enter into Infinity infinitive_Ends method");
    ...
    public static boolean mAtt(Stack s) {
        System.out.println("Enter into Infinity mAtt method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean check(Stack s) {
        System.out.println("Enter into Infinity check method");
