...
public class Tense {
    ...
    public static boolean check(Stack s) {
        System.out.println("Enter into Tense check method");
        ...
        // 1-in
            ...
            System.out.println("n_th of tense");
            ...
            if (ByteMeth.contains(topElmt, Constant.va)
                 ...
                 System.out.println("n_th of tense of contains");
    ...
    public static boolean human(Stack s) {
        System.out.println("Enter into Tense human method");
