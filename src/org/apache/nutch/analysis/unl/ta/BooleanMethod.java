...
public class BooleanMethod {
    ...
    static boolean is_akku_Pronoun(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod is_akku_Pronoun method");
    ...
    static boolean endsWith_Adjective(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Adjective method");
    ...
    static boolean isPronoun(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod isPronoun method");
    ...
    static boolean isPronoun_Case(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod isPronoun_Case method");
    ...
    static boolean isPronoun_Clitic(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod isPronoun_Clitic method");
    ...
    static byte[] endswith_doubling_Letter(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endswith_doubling_Letter method");
    ...
    static boolean endsWith_type4_letter(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_type4_letter method");
        ...
        if (ByteMeth.endsWith(topElmt, Constant.t)) {
            //System.out.println("In the result of t");
            return true;
        }
        ...
        if ((ByteMeth.endsWith(topElmt, Constant.th))){
            //&& ((!ByteMeth.startsWith(topElmt, Constant.n_)) || (!ByteMeth.startsWith(topElmt, Constant.m)) )){// ||(!(ByteMeth.startsWith(topElmt, Constant.m)))) { //i change here bcoz of the wrong split  for the word nadantha (நடந்த).
           if(!(ByteMeth.startsWith(topElmt, Constant.n_)) && (!(ByteMeth.startsWith(topElmt, Constant.m)))){
            //System.out.println("In the result of th"+UnicodeConverter.revert(topElmt));
            return true;
            }
        }
    ...
    static byte[] endsWith_Clitic_1_verb(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_1_verb method");
    ...
    static byte[] endsWith_Clitic_1_noun(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_1_noun method");
        for (int i = 0; i < Constant.CLITIC_1.length; i++) {
            if (ByteMeth.endsWith(topElmt, Constant.CLITIC_1[i])
                    && !ByteMeth.endsWith(topElmt, Constant.idaiyE)
                    && !ByteMeth.endsWith(topElmt, Constant.kuRukkE)
    ...
    static byte[] endsWith_Clitic_2(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_2 method");
    ...
    static byte[] endsWith_Clitic_3(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_3 method");
    ...
    static byte[] endsWith_Clitic_3a(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_3a method");
    ...
    static byte[] endsWith_Clitic_4(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_4 method");
    ...
    static byte[] endsWith_Clitic_5(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_5 method");
    ...
    static byte[] endsWith_Clitic_6(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_6 method");
    ...
    static byte[] endsWith_Clitic_12(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_12 method");
...
//-e 30/12/05 - 2
    ...
    static byte[] endsWith_Clitic_11(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_11 method");
...
//-e 30/12/05 - 2
    ...
    static byte[] endsWith_Clitic_7(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_7 method");
    ...
    static byte[] endsWith_Clitic_8(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_8 method");
    ...
    static byte[] endsWith_Clitic_9(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_Clitic_9 method");
    ...
    static boolean endsWith_PastTMHuman_Al(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_PastTMHuman_Al method");
    ...
    static boolean endsWith_PastTMHuman_Alum(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_PastTMHuman_Alum method");
        for (int i = 0; i < Constant.PAST_TM_HUMAN.length; i++) {
            if (ByteMeth.before_endswith(topElmt, Constant.PAST_TM_HUMAN[i],
                    Constant.Alum)) {
                return true;
    ...
    static boolean hasAux(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod hasAux method");
    ...
    static byte[] endsWith2(byte[] b1, byte[][] b2) {
        //System.out.println("Enter into BooleanMethod endsWith2 method");
    ...
    static boolean is_y_take_Vowel(byte b) {
        //System.out.println("Enter into BooleanMethod is_y_take_Vowel method");
    ...
    static boolean is_v_take_Vowel(byte b) {
        //System.out.println("Enter into BooleanMethod is_v_take_Vowel method");
    ...
    static boolean endsWith_AuxVerb(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod endsWith_AuxVerb method");
    ...
    static byte[] startsWith_prefix(byte[] topElmt) {
        //System.out.println("Enter into BooleanMethod startsWith_prefix method");
    ...
    public static boolean isVowel(byte b) {
        //System.out.println("Enter into BooleanMethod isVowel method");
    ...
    public static boolean isKCTP(byte b) {
        //System.out.println("Enter into BooleanMethod isKCTP method");
    ...
    static boolean has(Stack s, int tag, String inputString) {
        //System.out.println("Enter into BooleanMethod has method");
