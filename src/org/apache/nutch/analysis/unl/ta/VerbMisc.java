...
public class VerbMisc {
    ...
    public static boolean umpadi(Stack s) {
        System.out.println("Enter into VerbMisc umpadi method");
    ...
    public static boolean pastTM_Al(Stack s) {
        System.out.println("Enter into VerbMisc pastTM_Al method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean imperativeSingular1(Stack s) {
        System.out.println("Enter into VerbMisc imperativeSingular1 method");
    ...
    public static boolean imperativeSingular2(Stack s) {
        System.out.println("Enter into VerbMisc imperativeSingular2 method");
    ...
    public static boolean imperativePlural1(Stack s) {
        System.out.println("Enter into VerbMisc imperativePlural1 method");
    ...
    public static boolean imperativePlural2(Stack s) {
        System.out.println("Enter into VerbMisc imperativePlural2 method");
    ...
    public static boolean finiteVerb(Stack s) {
        System.out.println("Enter into VerbMisc finiteVerb method");
    ...
    public static boolean adverbial_Particle(Stack s) {
        System.out.println("Enter into VerbMisc adverbial_Particle method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean pronominal(Stack s) {
        System.out.println("Enter into VerbMisc  pronominal method");
