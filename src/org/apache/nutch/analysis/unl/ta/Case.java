...
public class Case {
    ...
    public static boolean check(Stack s, boolean pronominal) {
        System.out.println("Enter into Case check method");
        ...
        if (ByteMeth.endsWith(topElmt, Constant.il)) {
            System.out.println("Enter into Case check method il");
        ...
        if (pronominal) {
            ...
            if (ByteMeth.endsWith(topElmt, Constant.athu)
                ...
                System.out.println("pronominal in Case "+UnicodeConverter.revert(topElmt));
                s.push(new Entry(topElmt, -1, oldTopElmt));
                Sandhi.check(s);
                return true;
            }
