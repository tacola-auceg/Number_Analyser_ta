...
public class Sandhi {
    ...
    static String kctp_exception(Stack s) {
        System.out.println("Enter into Sandhi kctp_exception method");
        return null;
    }

    static byte[] remove_kctp(byte[] topElmt) {
        System.out.println("Enter into Sandhi remove_kctp method");
    ...
    static byte[] remove_kctp1(byte[] topElmt) {
        System.out.println("Enter into Sandhi remove_kctp1 method");
        if (ByteMeth.endsWith(topElmt, Constant.k)
                || ByteMeth.endsWith(topElmt, Constant.s)
                || ByteMeth.endsWith(topElmt, Constant.th)
                || ByteMeth.endsWith(topElmt, Constant.p)) {
    ...
    static void euphonic(Stack s) {
        System.out.println("Enter into Sandhi euphonic method");
    ...
    static void euphonic_in(Stack s) {
        System.out.println("Enter into Sandhi euphonic_in method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
        System.out.println("VAlue of topElmt in euphonic_in in sandhi "+UnicodeConverter.revert(topElmt));
    ...
    static void euphonic_an(Stack s) {
        System.out.println("Enter into Sandhi euphonic_an method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    public static boolean verbException(Stack s) {
        System.out.println("Enter into Sandhi verbException method");
    ...
    public static boolean handleException(Stack s) {
        System.out.println("Enter into Sandhi handleException method");
    ...
    static void clitic(Stack s) {
        System.out.println("Enter into Sandhi clitic method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void postposition(Stack s) {
        System.out.println("Enter into Sandhi postposition method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void check(Stack s) {
        System.out.println("Enter into Sandhi check method");
    ...
    static boolean type1(Stack s) {
        System.out.println("Enter into Sandhi type1 method");
        // 1 - aRRu
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean type2(Stack s) {
        System.out.println("Enter into Sandhi type2 method");
        // 2 - v,y sandhi
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean type2_clitic(Stack s) {
        System.out.println("Enter into Sandhi type2_clitic method");
        // 2 - v,y sandhi
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean type3(Stack s) {
        System.out.println("Enter into Sandhi type3 method");
        // 3 - aththu
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;

        if (ByteMeth.endsWith(topElmt, Constant.athth)) {
            if (!(ByteMeth.endsWith(topElmt, Constant.pathth)
    ...
    static boolean type4(Stack s) {
        System.out.println("Enter into Sandhi type4 method");
        // 4 - add u
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
        System.out.println("sandhi:"+UnicodeConverter.revert(topElmt));
        if (BooleanMethod.endsWith_type4_letter(topElmt)) {
            if ((!ByteMeth.endsWith(topElmt, Constant.ERk))) {//|| (!ByteMeth.startsWith(topElmt, Constant.nadanth))) {
                System.out.println("Enter into method of if in type4"+UnicodeConverter.revert(topElmt));
                //clia.unl.unicode.utils.Utils.printOut(Analyser.print, x + "type 4");
                s.pop();
                topElmt = ByteMeth.addArray(topElmt, Constant.u);
                System.out.println("Enter into method of if in type4 of next "+UnicodeConverter.revert(topElmt));
                s.push(new Entry(topElmt, -1, oldTopElmt));

            } else {
                System.out.println("Enter into method of else in type4");
                s.pop();
                topElmt = ByteMeth.subArray(topElmt, 0,
    ...
    static boolean type5(Stack s) {
        System.out.println("Enter into Sandhi type5 method");
        // 5 - doubling
        int flag = 0;
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static boolean type6(Stack s) {
        System.out.println("Enter into Sandhi type6 method");
        // 6 - t - oblique
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void kk(Stack s) {
        System.out.println("Enter into Sandhi kk method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void kctp(Stack s) {
        System.out.println("Enter into Sandhi kctp method");
    ...
    static void k(Stack s) {
        System.out.println("Enter into Sandhi k method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void s(Stack s) {
        System.out.println("Enter into Sandhi s method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void th(Stack s) {
        System.out.println("Enter into Sandhi th method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
    ...
    static void p(Stack s) {
        System.out.println("Enter into Sandhi p method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
...
//          added this mehtod to check whether thAn comes with th
    static boolean th(Stack s, boolean b) {
        System.out.println("Enter into Sandhi th two dimen method");
        byte[] topElmt = ((Entry) s.peek()).getPart();
        byte[] oldTopElmt = topElmt;
