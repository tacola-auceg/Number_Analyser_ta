...
public class Constant {
    ...
    static byte yam[] = {24, 1, 23};//யம்
    static byte ang[] = {1, 15};//அங்
    static byte yng[] = {24, 1, 15};//யங்
    static byte sandhi_ik[] = {14};
    static byte sandhi_iCH[] = {16};
    static byte sandhi_iT[] = {18};
    static byte sandhi_iTH[] = {20};
    static byte sandhi_iP[] = {22};
    static byte sandhi_iR[] = {30};
    static byte sandhi_yi[] = {24};
    static byte per[] = {22, 8, 25};
    static byte citrur[] = {16, 30, 30, 25};
    static byte perumai[] = {22, 7, 30, 5, 23, 9};
    static byte sirumai[] = {16, 3, 30, 5, 23, 9};
    ...
    static byte aRu[] = {1, 30, 5};//அறு
    //For numbers
    static byte onr[] = {10, 31, 30};//ஒன்று
    static byte Onr[] = {11, 31, 30};//ஒன்று
    static byte erand[] = {3, 25, 1, 19, 18};//இரண்டு
    static byte mUnr[] = {23, 6, 31, 30};//மூன்
    static byte padhi[]={22,1,20,3};
    static byte naang[] = {21, 2, 31, 14};//நான்கு
    static byte Ang[] = {2, 31, 14};//
    static byte aindh[] = {9, 21, 20};//ஐந்து
    static byte aar[] = {2, 30};//ஆறு
    static byte Ez[] = {8, 28};//ஏழு
    static byte ett[] = {7, 18, 18};//எட்டு
    static byte onbadh[] = {10, 31, 22, 1, 20};//ஒன்பது
    static byte patthu[] = {22, 1, 20, 20, 5};//பத்த்
    static byte patth[] = {22, 1, 20, 20};//பத்த்
    static byte Ayira[] = {2, 24, 3, 25, 1};//ஆயிர
    static byte latcha[] = {26, 1, 18, 16, 1};//
    static byte ilatcha[] = {3, 26, 1, 18, 16, 1};//
    static byte Ayiraththu[] = {2, 24, 3, 25, 1, 20, 20, 5};//ஆயிரத்து
    static byte aimbadhth[] = {9, 23, 22, 1, 20};//ஐம்பத்
    static byte aimbadhthu[] = {9, 23, 22, 1, 20, 5};//ஐம்பத்
    static byte erubadh[] = {3, 25, 5, 22, 1, 20};//இருபத்
    static byte erubadhu[] = {3, 25, 5, 22, 1, 20, 5};//இருபத்
    static byte muppadh[] = {23, 5, 22, 22, 1, 20};
    static byte muppadhu[] = {23, 5, 22, 22, 1, 20, 5};
    static byte nARbadh[] = {21, 2, 30, 22, 1, 20};
    static byte nARbadhu[] = {21, 2, 30, 22, 1, 20, 5};
    static byte badhu[] = {22, 1, 20, 5};//
    static byte arubadh[] = {1, 30, 5, 22, 1, 20};
    static byte arubadhu[] = {1, 30, 5, 22, 1, 20, 5};//
    static byte ezhubadh[] = {7, 28, 5, 22, 1, 20};
    static byte ezhubadhu[] = {7, 28, 5, 22, 1, 20, 5};
    static byte enbadh[] = {7, 19, 22, 1, 20};
    static byte enbadhu[] = {7, 19, 22, 1, 20, 5};//
    static byte thonnootr[] = {20, 10, 19, 19, 6, 30};
    static byte thonnootru[] = {20, 10, 19, 19, 6, 30, 5};
    static byte erNooru[] = {3, 25, 5, 21, 6, 30, 5};
    static byte Nootru[] = {21, 6, 30, 30, 5};//
    static byte thool[]={20,10,29,29};//
    
    //colloquial
    //static byte Arththu[] = {2, 25, 20, 20, 5};//ஆர்த்து
    //static byte ppa[] = { 22, 22, 1};  //ப்ப
    static byte ula[] = {5, 26, 1};//உல
    static byte ukinRathu[] = {5, 14, 3, 31, 30, 1, 20, 5};//உகின்றது
    static byte inRathu[] = {3, 31, 30, 1, 20, 5};//இன்றது
    static byte udhu[] = {5, 20, 5};  //உது
    static byte kinreyn[] = {14, 3, 31, 30, 8, 31};//கின்றேன்
    static byte Ndum[] = {19, 18, 5, 23};//ண்டும்
    static byte pa[] = {22, 1};//ப
    static byte la[] = {26, 1};//ல
    static byte kiRa[] = {14, 3, 30, 1};//கிற
    static byte kiRai[] = {14, 3, 30, 2, 24};//கிறாய்
    static byte kkiRa[] = {14, 14, 3, 30, 1};//க்கிற
    static byte kkiRai[] = {14, 14, 3, 30, 2, 24};//க்கிறாய்
    static byte Yndhu[] = {24, 21, 20, 5};//ய்ந்து
    static byte nju[] = {17, 16, 5};//ஞ்சு
    static byte ydhu[] = {24, 20, 5};//ய்து
    static byte yidhu[] = {24, 3, 20, 5};//யிது
    static byte yudhu[] = {24, 5, 20, 5};//யுது
    static byte kiRathu[] = {14, 3, 30, 1, 20, 5};//கிறது
    static byte yikinRathu[] = {24, 14, 3, 31, 30, 1, 20, 5};//ய்கின்றது
    static byte yinum[] = {24, 3, 31, 5, 23};//யினும்
    static byte naalum[] = {31, 2, 26, 5, 23};//னாலும்
    static byte mputtu[] = {23, 22, 5, 18, 18, 5};//ம்புட்டு
    //static byte mput[]={23,22,5,18};//ம்புட்
    static byte vvalavu[] = {27, 27, 1, 29, 1, 27, 5};//வ்வளவு
    static byte rththu[] = {30, 20, 20, 5};//ர்த்து
    static byte rth[] = {30, 20};//ர்த்
    static byte kinRathu[] = {14, 3, 31, 30, 1, 20, 5};//கின்றது
    static byte nRathu[] = {31, 30, 1, 20, 5};//ன்றது
    static byte kudhu[] = {14, 5, 20, 5};//குது
    static byte villai[] = {27, 3, 26, 26, 9};//வில்லை
    static byte villaiyenRaal[] = {27, 3, 26, 26, 9, 24, 7, 31, 30, 2, 26};//வில்லையென்றால்
    //static byte thuchchi[]={20,5,16,16,3};//துச்சி
    static byte uchchi[] = {5, 16, 16, 3};//உச்சி
    static byte duchchi[] = {18, 5, 16, 16, 3};//டுச்சி
    //static byte ittadhu[]={3,18,18,1,20,5};//இட்டது
    static byte vittadhu[] = {27, 3, 18, 18, 1, 20, 5};//விட்டது
    static byte Oda[] = {11, 18, 1};//ஓட
    //static byte duchchi[]={18,5,16,16,3};//டுச்சி
    //static byte thathu[] ={20,1,20,5};//தது
    static byte lluchchi[] = {26, 26, 5, 16, 16, 3};//ல்லுச்சி
    static byte nnadhu[] = {31, 31, 1, 20, 5};//ன்னது
    static byte kammiya[] = {14, 1, 23, 23, 3, 24, 2};//கம்மியா
    static byte kuraivaga[] = {14, 5, 30, 9, 27, 2, 14, 1};//குறைவாக
    static byte su[] = {16, 5};//சு
    static byte yathu[] = {24, 1, 20, 5};//யது
    static byte itta[] = {3, 18, 18, 1};//இட்ட
    static byte lidam[] = {29, 3, 18, 1, 23};//ளிடம்
    static byte yoda[] = {24, 11, 18, 1};//யோட
    static byte yudan[] = {24, 5, 18, 1, 31};//யுடன்
    static byte kaLaa[] = {14, 1, 29, 2};//களா
    static byte kaRaa[] = {14, 1, 30, 2};//கறா
    static byte kiRaal[] = {14, 3, 30, 2, 29};//கிறாள்
    static byte kunga[] = {14, 5, 15, 14, 1};//குங்க
    static byte kkol[] = {14, 14, 10, 29};//க்கொள்
    static byte ukiraaragal[] = {5, 14, 3, 30, 2, 25, 14, 1, 29};//uகிறார்கள்
    static byte kraanga[] = {14, 1, 30, 2, 15, 14, 1};//கறாங்க
    static byte raaragal[] = {30, 2, 25, 14, 1, 29};//றார்கள்
    static byte kiraaragal[] = {14, 3, 30, 2, 25, 14, 1, 29};//கிறார்கள்
    static byte nnu[] = {31, 31, 5};//ன்னு
    static byte nnaa[] = {31, 31, 2};//ன்னா
    static byte yenRaal[] = {24, 7, 31, 30, 2, 26};//யென்றால்
    static byte Uril[] = {6, 25, 3, 26};  //ஊரில்
    static byte Urla[] = {6, 25, 26, 1};  //ஊர்ல
    static byte Ngu[] = {17};//ஞ்
    static byte Laa[] = {29, 2};//ளா
    static byte Day[] = {18, 8};//டே
    static byte they[] = {20, 8};//தே
    static byte ken[] = {14, 8, 31};//கேன்
    static byte iren[] = {3, 30, 8, 31};//இறேன்
    static byte Num[] = {19, 5, 23};//ணும்
    static byte chchu[] = {16, 16, 5};//ச்சு
    static byte ichchu[] = {3, 16, 16, 5};//இச்சு
    static byte Achchu[] = {2, 16, 16, 5};//ஆச்சு
    static byte yitru[] = {24, 3, 30, 30, 5};//யற்று
    static byte lirunthu[] = {26, 3, 25, 5, 21, 20, 5};//லிருந்து
    static byte vilirunthu[] = {27, 3, 26, 3, 25, 5, 21, 20, 5};//விலிருந்து
    static byte inga[] = {4, 15, 14, 1}; //ஈங்க
    static byte Ki[] = {14, 4}; //கீ
    static byte ireerkal[] = {3, 30, 4, 25, 14, 1, 29};//இறீர்கள்
    static byte kaan[] = {14, 2, 31};//கான்
    static byte kiraan[] = {14, 3, 30, 2, 31};//கிறான்
    static byte vaRoom[] = {27, 1, 30, 8, 23};//வறோம்
    static byte varukirrom[] = {27, 1, 25, 5, 30, 8, 23};//வருகிறோம்
    //static byte ikku[]={3,14,14,5};
    static byte nikku[] = {31, 3, 14, 14, 5};//னிக்கு
    static byte kinradhA[] = {14, 3, 31, 30, 1, 20, 2};//கின்றதா
    static byte raiku[] = {30, 9, 14, 14, 5};//றைக்கு
    static byte kinu[] = {14, 3, 31, 5};//கினு
    //static byte koNdiru[]={14,10,19,18,3,25,5};//கொண்டிருக்
    static byte kkoNdiru[] = {14, 14, 10, 19, 18, 3, 25, 5};//க்கொண்டிருக்
    static byte duren[] = {18, 5, 30, 8, 31};//டுறேன்
    static byte vidukiren[] = {27, 3, 18, 5, 14, 3, 30, 8, 31};//விடுகிறேன்
    static byte raanga[] = {30, 2, 15, 14, 1};//றாங்க
    static byte raarkal[] = {30, 2, 25, 14, 1, 29};//றார்கள்
    static byte virkku[] = {27, 3, 30, 14, 5};//விற்கு
    static byte yil[] = {24, 3, 26};//யில்
    static byte karadhu[] = {14, 1, 30, 1, 20, 5};//கறது
    static byte Teer[] = {18, 4, 25};//டீர்
    //static byte ARRu[] = { 2, 30, 30, 5};//ஆற்று
    // TENSE
    ...
    static byte n_kuru[] = {14, 5, 30, 5};//குறு
    static byte mai[] = {23, 9};
    // Sandhi
    ...
    static byte AAththu[] = {2, 20, 20, 5};//ஆத்து
    static byte iththu[] = {3, 20, 20, 5};//இத்து
    ...
    //static byte nn[] = { 31, 31}; //ன்ன்
    static byte m[] = {23};// ம்
    static byte Arai[] = {25, 9};
    static byte odi[] = {18, 3};
    ...
    static byte ippu[] = {22, 22, 5};
    static byte a[] = {1};//அ
    static byte au[] = {12};//ஒள
    static byte A[] = {2};//ஆ
    static byte O[] = {11};//ஓ
    static byte ka[] = {14, 1};//க
    static byte kA[] = {14, 2};//கா
    static byte i[] = {3};//இ
    static byte u[] = {5};//உ
    ...
    static byte nadanth[] = {21, 1, 18, 1, 21, 20};//நடந்த்
    static byte n_a[] = {21, 1};//ந
    // post positions
